  ...
  attributes: {
    ...
    rate: Attribute.Decimal &
      Attribute.SetMinMax<
        ...
        number
      >;
    serial: Attribute.Relation<
      'api::book.book',
      'manyToOne',
      'api::serial.serial'
    >;
    borrowing_lists: Attribute.Relation<
      'api::book.book',
      'oneToMany',
      'api::borrowing-list.borrowing-list'
    >;
...
export interface ApiBorrowingListBorrowingList extends Schema.CollectionType {
  collectionName: 'borrowing_lists';
  info: {
    singularName: 'borrowing-list';
    pluralName: 'borrowing-lists';
    displayName: 'Borrowing List';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiSerialSerial extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::borrowing-list.borrowing-list': ApiBorrowingListBorrowingList;
